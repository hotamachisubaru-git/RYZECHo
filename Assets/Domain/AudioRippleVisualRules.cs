...
internal static class AudioRippleVisualRules
{
        ...
        bool sharedOnly)
    {
        ...
        var fadeProgress = isBreathing
            ? Math.Clamp(progress * GameRules.BreathingRippleFadeOutSeconds / GameSettings.RippleDurationSeconds, 0f, 1f)
            : clampedProgress;
        var alpha = (int)(baseAlpha * (1f - fadeProgress) * occlusion.AlphaMultiplier);
