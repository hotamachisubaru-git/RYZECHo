...
namespace RYZECHo
{
    ...
    internal static class GameLayout
    {
        ...
        static GameLayout()
        {
            _settings = Resources.Load<LayoutSettingsSO>("LayoutSettings");
        }
        ...
        public static LayoutSettingsSO? Settings => _settings;
    }
    ...
    internal static class GameRules
    {
        ...
        static GameRules()
        {
            _settings = Resources.Load<GameRulesSettingsSO>("GameRulesSettings");
        }
        ...
        /// <summary>ScriptableObject への参照。インスペクタ調整用。</summary>
        public static GameRulesSettingsSO? Settings => _settings;
    }
}
