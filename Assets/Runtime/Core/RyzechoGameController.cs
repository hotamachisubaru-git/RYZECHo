...

{
...

    {
        ...
        // ESC-0114: Public for external access (SceneBuilder)
        public GameplaySettingsSO GameplaySettings { get => gameplaySettings; set => gameplaySettings = value; }

        [SerializeField] private GameRulesSettingsSO gameRulesSettings;



        public GameRulesSettingsSO GameRulesSettings { get => gameRulesSettings; set => gameRulesSettings = value; }

        [SerializeField] private LayoutSettingsSO layoutSettings;



        public LayoutSettingsSO LayoutSettings { get => layoutSettings; set => layoutSettings = value; }

        [SerializeField] private VisualSettingsSO visualSettings;



        public VisualSettingsSO VisualSettings { get => visualSettings; set => visualSettings = value; }
        ...
        public AudioSettingsSO AudioSettings { get => audioSettings; set => audioSettings = value; }

        [Header("World Mapping")]



        [SerializeField] private Vector2 _worldOrigin = new(-9f, -6f);



        [SerializeField] private float _cellSizeUnits = 1f;
        ...
        [SerializeField] private bool _followPlayerCamera = true;
        ...
        [SerializeField] private float _cameraLerp = 18f;
        ...
        // ESC-0114: Public properties for external access (Bootstrap, SceneBuilder)



        public Vector2 worldOrigin { get => _worldOrigin; set => _worldOrigin = value; }



        public float cellSizeUnits { get => _cellSizeUnits; set => _cellSizeUnits = value; }



        public bool followPlayerCamera { get => _followPlayerCamera; set => _followPlayerCamera = value; }
        ...
        public float cameraLerp { get => _cameraLerp; set => _cameraLerp = value; }



        public float orthographicSize { get => _orthographicSize; set => _orthographicSize = value; }
