...
public readonly record struct EconomyEvent
{
    ...
    /// <summary>スキル購入イベントの作成。</summary>
    public static EconomyEvent SkillPurchase(string currencyId, int amount, string message = "")
        => new(EconomyEventType.SkillPurchase, currencyId, -amount, "Skill", message);
}
