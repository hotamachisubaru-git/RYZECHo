...
namespace RYZECHo.Runtime.Effects
{
    ...
    public class SelectionHighlight : MonoBehaviour
    {
        ...
        public void PauseBlink(bool pause)
        {
            ...
            {
                var c = _renderer.color;
                c = new Color(c.r, c.g, c.b, maxAlpha);
                _renderer.color = c;
            }
            else
            {
        ...
        private void OnValidate()
        {
            ...
            if (highlightColor.a > 1f)
            {
                highlightColor = new Color(highlightColor.r, highlightColor.g, highlightColor.b, Mathf.Clamp01(highlightColor.a));
            }
