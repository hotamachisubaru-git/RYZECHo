    ...
    public class CameraTransitionEffect : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (fadeImage == null && fadeCanvas != null)
            {
                ...
                fadeImage.fillMethod = UnityEngine.UI.Image.FillMethod.Horizontal;
        ...
        /// ビュー切り替え時のトランジションを開始
        /// </summary>
        public void StartTransition(CameraViewMode targetView)
        {
        ...
        public void StartFadeTransition(float fadeTime = -1f, bool fadeIn = true)
        {
            ...
            var duration = fadeTime > 0 ? fadeTime : fadeDuration;
            _activeCoroutine = StartCoroutine(fadeIn ? FadeInCoroutine(duration) : FadeOutCoroutine(duration));
        }
        ...
        /// メイントランジションコルーチン
        /// </summary>
        private IEnumerator TransitionCoroutine(CameraViewMode targetView)
        {
